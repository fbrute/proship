...
exports.shipment_build_sql = function(request) {
  ...
  function validParamsTransportFilter() {
  ...
  function validParamsSortingDirection() {
  ...
  function validParamsPagination() {
    // Handle pagination
  ...
  validParamsCompanyId();
  validParamsTransportFilter();
  validParamsSortingDirection();
  validParamsPagination();
